...
using project_c.Areas.Admin.Models
...
namespace project_c.Areas.Admin.Controllers
{
    ...
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> GamesOverTime()
        {
            var gameList = await _context.Games.ToListAsync();
            var join = new GameAmountJoin(
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Genre,Pegi,Description,Price,ProducingCompany")] Game game)
        {
